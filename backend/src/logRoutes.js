...
// Rotas de Logs de Notificação e Gerenciamento de Incidentes
logRoutes.get('/logs/notifications', NotificationLogController.index);
logRoutes.get('/logs/notifications/my-replies', NotificationLogController.getRecentRepliesForUser);
logRoutes.post('/logs/notifications/mark-replies-as-read', NotificationLogController.markRepliesAsRead);
...
// Rotas de EXPORTAÇÃO de relatórios (utilizando o ReportController)
